...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@foodi-cluster.acaik0n.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        // update items quantity from cart
