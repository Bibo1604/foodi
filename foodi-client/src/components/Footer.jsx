...
const Footer = () => {
    return (
        <div>
            <footer className="footer py-10 px-4 xl:px-24 section-bg-color text-black">
                <aside>
                ...
                <nav>
                    ...
                    <a className="link link-hover">+1 234567890</a>
            ...
            <footer className="footer items-center py-10 px-4 xl:px-24 section-bg-color text-black">
