...
const UpdateMenu = () => {
    ...
    return (
        <div className='w-full md:w-[870px] px-4 mx-auto'>
            <h2 className='text-2xl font-semibold my-4'>Update <span className='text-green'>Menu Item</span></h2>
            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-control">
                        ...
                        <textarea defaultValue={item.recipe} {...register("recipe", { required: true })} className="textarea textarea-bordered h-24" placeholder="Tell the worlds about your recipe"></textarea>
                    </div>
