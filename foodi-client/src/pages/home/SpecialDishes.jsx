...
const SpecialDishes = () => {
    ...
    return (
        <div className='section-container section-bg-color py-20 text-black relative'>
            ...
            {/* arrow buttons */}
            <div className='md:absolute right-3 top-32 mb-10 md:mr-24'>
                <button onClick={() => slider?.current?.slickPrev()} className='btn p-2 rounded-full ml-5 bg-slate-100 border-none'>
