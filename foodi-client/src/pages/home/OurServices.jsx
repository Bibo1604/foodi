...
const servicesList = [
    ...
    },
    {
        ...
        des: "Explore meny & order with ease using our Online Ordering",
...
const OurServices = () => {
  return (
    <div className='section-container section-bg-color text-black py-16'>
            ...
            <div className='md:w-1/2'>
                <div className='text-left md:w-4/5'>
                    ...
                    <p className='my-5 text-secondary leading-[30px]'>
                        Rooted in passion, we curate unforgettable dinning experiences and offer exceptional services,
