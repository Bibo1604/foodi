                            ...
                            <tbody>
                                ...
                                {cart.map((item, index) => (
                                    <tr key={index} className='text-black'>
                                        ...
                                        <td>
                                            <button className='btn btn-xs bg-slate-200 hover:bg-slate-300 text-black text-md border-none' onClick={() => handleDecrease(item)} disabled={item.quantity === 1}>-</button>
